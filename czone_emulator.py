...
MODBUS_INTER_FRAME_GAP_SECONDS = 0.025
MODBUS_INTER_DEVICE_COMMAND_DELAY_SECONDS = float(os.getenv("MODBUS_INTER_DEVICE_COMMAND_DELAY_SECONDS", "0.5"))
CIRCUIT_LOAD_MAPS = {
    0x07: 1,
    0x08: 2,
    0x09: 3,
