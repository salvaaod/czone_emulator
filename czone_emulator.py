...
const mappingStatus=document.createElement('div');mappingStatus.className='mapping-line';mappingStatus.textContent=`Mapping source: ${cfg.message||'Unknown'} | ${fileText}`;mapping.appendChild(mappingStatus);
