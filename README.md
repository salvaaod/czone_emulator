...
- `WEB_SERVER`: `1/true/yes` to enable the Flask web UI/API even when GUI mode is active.
...
When the web server is enabled (by `HEADLESS=1`, Linux without `DISPLAY`, or `WEB_SERVER=1`):
